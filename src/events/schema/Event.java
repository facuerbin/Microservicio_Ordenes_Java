...
public class Event {
    ...
    private CancelOrderEvent cancel;
    ...
    public static Event cancelOrder(String orderId, String userId, CancelOrderEvent.Reason reason) {
        Event result = new Event();
        result.orderId = new ObjectId(orderId);
        result.type = EventType.CANCEL_ORDER;
        result.cancel = new CancelOrderEvent(userId, reason);
        return result;
    }
    ...
    public CancelOrderEvent getCancel () {return cancel;}
}
